...
function $(){try{return re.activeElement}catch(e){}}function S(e,t,n,i,o,s){var r,a;
...
u=$(e)).length;s--;)u[s]="#"+a+" "+p(u[s]);c=u.join(","),
...
t||(t=$(e)),n=t.length;n--;)(s=m(t[n]))[R]?i.push(s):o.push(s);
 ...
 */
j=w.select=function(e,t,n,i){var o,s,r,a,l,u="function"==typeof e&&e,c=!i&&$(e=u.selector||e);
...
e.jquery?e[0]:e):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(e,t){return this.pushStack(Ce.uniqueSort(Ce.merge(this.get(),Ce(e,t))))},addBack:function(e){return this.add(null==e?this.prevObject:this.prevObject.filter(e))}}),Ce.each({parent:function(e){var t=e.parentNode;return t&&11!==t.nodeType?t:null},parents:function(e){return Ee(e,"parentNode")},parentsUntil:function(e,t,n){return Ee(e,"parentNode",n)},next:function(e){return n(e,"nextSibling")},prev:function(e){return n(e,"previousSibling")},nextAll:function(e){return Ee(e,"nextSibling")},prevAll:function(e){return Ee(e,"previousSibling")},nextUntil:function(e,t,n){return Ee(e,"nextSibling",n)},prevUntil:function(e,t,n){return Ee(e,"previousSibling",n)},siblings:function(e){return $e((e.parentNode||{}).firstChild,e)},children:function(e){return $e(e.firstChild)},contents:function(e){return u(e,"iframe")?e.contentDocument:(
...
// ( types [, fn] )
n=t,t=void 0),!1===n&&(n=E),this.each(function(){Ce.event.remove(this,e,n,t)});
...
Ce.fx.step={};var Ct,Tt,kt=/^(?:toggle|show|hide)$/,Et=/queueHooks$/,$t,St,jt;Ce.Animation=Ce.extend(U,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return v(n.elem,e,Ye.exec(t),n),n}]},tweener:function(e,t){for(var n,i=0,o=(e=ye(e)?(t=e,["*"]):e.match(Le)).length;i<o;i++)n=e[i],U.tweeners[n]=U.tweeners[n]||[],U.tweeners[n].unshift(t)},prefilters:[V],prefilter:function(e,t){t?U.prefilters.unshift(e):U.prefilters.push(e)}}),Ce.speed=function(e,t,n){var i=e&&"object"==typeof e?Ce.extend({},e):{complete:n||!n&&t||ye(e)&&e,duration:e,easing:n&&t||t&&!ye(t)&&t};
...
(o||Ne.get(this,"finish"))&&e.stop(!0)};return r.finish=r,o||!1===s.queue?this.each(r):this.queue(s.queue,r)},stop:function(o,e,s){var r=function(e){var t=e.stop;delete e.stop,t(s)};return"string"!=typeof o&&(s=e,e=o,o=void 0),e&&!1!==o&&this.queue(o||"fx",[]),this.each(function(){var e=!0,t=null!=o&&o+"queueHooks",n=Ce.timers,i=Ne.get(this);if(t)i[t]&&i[t].stop&&r(i[t]);else for(t in i)i[t]&&i[t].stop&&Et.test(t)&&r(i[t]);for(t=n.length;t--;)n[t].elem!==this||null!=o&&n[t].queue!==o||(n[t].anim.stop(s),e=!1,n.splice(t,1));
...
Ce.fn.delay=function(i,e){return i=Ce.fx&&Ce.fx.speeds[i]||i,e=e||"fx",this.queue(e,function(e,t){var n=T.setTimeout(e,i);t.stop=function(){T.clearTimeout(n)}})},$t=re.createElement("input"),jt=re.createElement("select").appendChild(re.createElement("option")),$t.type="checkbox",
...
$t=re.createElement("input")).value="t",$t.type="radio",ve.radioValue="t"===$t.value;var Ot,_t=Ce.expr.attrHandle;Ce.fn.extend({attr:function(e,t){return qe(this,Ce.attr,e,t,1<arguments.length)},removeAttr:function(e){return this.each(function(){Ce.removeAttr(this,e)})}}),Ce.extend({attr:function(e,t,n){var i,o,s=e.nodeType;
...
/* harmony import */var $=n(/*! ../foundation.orbit */"./js/foundation.orbit.js");
/* harmony reexport (safe) */n.d(t,"Orbit",function(){return $.Orbit});
...
/**
         ...
         */
this.getUrl=j.default,this.cache=new c.default,this.link=new h.default,this.transitionEndEvent=(0,p.default)(),this.getDataFromHtml=y.default,this.getPage=g.default,this.scrollTo=_.default,this.loadPage=w.default,this.renderPage=C.default,this.createState=k.default,this.triggerEvent=$.default,this.classify=P.default,this.doScrolling=L.default,this.markSwupElements=D.default,this.on=H.default,this.off=R.default,this.updateTransition=F.default,this.preloadPage=G.default,this.preloadPages=Y.default,this.usePlugin=X.default,this.log=K.default,this.enable=this.enable,this.destroy=this.destroy,
...
p[E()]="mouse",v(),b("input"),b("intent")},v=function e(){
...
var a=document.activeElement,l;if(a&&a.nodeName&&-1===d.indexOf(a.nodeName.toLowerCase())){c=i;try{window.sessionStorage.setItem("what-intent",c)}catch(e){}b("intent")}}}},b=function e(t){n.setAttribute("data-what"+t,"input"===t?u:c),$(t)},w=function e(t){
// only execute if the event buffer timer isn't running
...
return t="onwheel"in document.createElement("div")?"wheel":void 0!==document.onmousewheel?"mousewheel":"DOMMouseScroll"},$=function e(t){for(var n=0,i=s.length;n<i;n++)s[n].type===t&&s[n].fn.call(void 0,"input"===t?u:c)},S=function e(t){for(var n=0,i=s.length;n<i;n++)if(s[n].fn===t)return n},j=function e(t){a.x!==t.screenX||a.y!==t.screenY?(r=!1,a.x=t.screenX,a.y=t.screenY):r=!0};
/*
	   * events
	   */
/*
