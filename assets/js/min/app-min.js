...
function f(e){return e.replace(Ie,"ms-").replace(He,o)}function s(){this.expando=Ce.expando+s.uid++}function r(e){return"true"===e||"false"!==e&&("null"===e?null:
...
// TODO: identify versions
// getElementById can match elements by name instead of ID
if(d&&(r=d.getElementById(o))&&H(t,r)&&r.id===o)return n.push(r),n;
// Type selector
...
e.querySelectorAll("*,:x"),D.push(",.*:")})),(C.matchesSelector=ge.test(I=L.matches||L.webkitMatchesSelector||L.mozMatchesSelector||L.oMatchesSelector||L.msMatchesSelector))&&o(function(e){
...
H=t||ge.test(L.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,i=t&&t.parentNode;return e===i||!(!i||1!==i.nodeType||!(n.contains?n.contains(i):e.compareDocumentPosition&&16&e.compareDocumentPosition(i)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0;return!1},
/* Sorting
	---------------------------------------------------------------------- */
...
t=t.replace(ce,"='$1']"),C.matchesSelector&&A&&!Y[t+" "]&&(!q||!q.test(t))&&(!D||!D.test(t)))try{var n=I.call(e,t);
...
r&&(i=Ye.exec(t))&&"px"!==(i[3]||"px")&&(e.style[a]=t,t=Ce.css(e,a)),H(e,t,r)}}}),Ce.cssHooks.marginLeft=D(ve.reliableMarginLeft,function(e,t){if(t)return(parseFloat(A(e,"marginLeft"))||e.getBoundingClientRect().left-Ue(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),
// These hooks are used by animate to expand properties
Ce.each({margin:"",padding:"",border:"Width"},function(o,s){Ce.cssHooks[o+s]={expand:function(e){for(var t=0,n={},
// Assumes a single number if not a string
i="string"==typeof e?e.split(" "):[e];t<4;t++)n[o+Ve[t]+s]=i[t]||i[t-2]||i[0];return n}},"margin"!==o&&(Ce.cssHooks[o+s].set=H)}),Ce.fn.extend({css:function(e,t){return qe(this,function(e,t,n){var i,o,s={},r=0;if(Array.isArray(t)){for(i=pt(e),o=t.length;r<o;r++)s[t[r]]=Ce.css(e,t[r],!1,i);return s}return void 0!==n?Ce.style(e,t,n):Ce.css(e,t)},e,t,1<arguments.length)}}),(Ce.Tween=F).prototype={constructor:F,init:function(e,t,n,i,o,s){this.elem=e,this.prop=n,this.easing=o||Ce.easing._default,this.options=t,this.start=this.now=this.cur(),this.end=i,this.unit=s||(Ce.cssNumber[n]?"":"px")},cur:function(){var e=F.propHooks[this.prop];return e&&e.get?e.get(this):F.propHooks._default.get(this)},run:function(e){var t,n=F.propHooks[this.prop];return this.options.duration?this.pos=t=Ce.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration):this.pos=t=e,this.now=(this.end-this.start)*t+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),n&&n.set?n.set(this):F.propHooks._default.set(this),this}},F.prototype.init.prototype=F.prototype,F.propHooks={_default:{get:function(e){var t;
...
g.data&&(g.processData||"string"==typeof g.data)&&(d+=(It.test(d)?"&":"?")+g.data,
// #9682: remove data so that it's not used in an eventual retry
delete g.data),
// Add or update anti-cache param if needed
!1===g.cache&&(d=d.replace(Wt,"$1"),r=(It.test(d)?"&":"?")+"_="+qt+++r),
...
r?e[r]=e[r].replace(on,"$1"+i):!1!==e.jsonp&&(e.url+=(It.test(e.url)?"&":"?")+e.jsonp+"="+i),
...
/**
         ...
         */
this.getUrl=j.default,this.cache=new c.default,this.link=new h.default,this.transitionEndEvent=(0,p.default)(),this.getDataFromHtml=y.default,this.getPage=g.default,this.scrollTo=_.default,this.loadPage=w.default,this.renderPage=C.default,this.createState=k.default,this.triggerEvent=E.default,this.classify=P.default,this.doScrolling=L.default,this.markSwupElements=D.default,this.on=I.default,this.off=R.default,this.updateTransition=F.default,this.preloadPage=G.default,this.preloadPages=Y.default,this.usePlugin=X.default,this.log=K.default,this.enable=this.enable,this.destroy=this.destroy,
...
// 1. Loading
// --------------------
$(function(){"true"!=$.cookie("showed_modal")&&($(".loader").removeClass("hide"),setTimeout(function(){$(".loader").addClass("loaded")},5e3),$.cookie("showed_modal","true",{expires:365}))}),
// 2. Animate on Scroll
// --------------------
